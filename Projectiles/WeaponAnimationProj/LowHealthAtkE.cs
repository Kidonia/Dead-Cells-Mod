...
public class LowHealthAtkE : DC_WeaponAnimation
{
    //以此为模板。
    ...
    {
        DrawWeaponTexture(WeaponDic, 12, -35, true, new(255, 233, 120));//帧图绘制武器动画
        DrawfxTexture(fxDic, 12, -35, true, new(255, 90, 0));//帧图绘制fx特效图
    }

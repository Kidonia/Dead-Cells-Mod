...
public class SoulProj : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.DamageType = SurvivalDamage.Instance;
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        Projectile.velocity.X = NormalUtils.Rand1or_1() * Main.rand.NextFloat(1.49f, 1.94f);
    ...
    public override void AI()
    {
        ...
        {
            // 执行条件 npc没死 且 不是友方npc 且 target为null 且 npc不是训练假人

            if (!npc.active || npc.friendly || target != null || npc.type == NPCID.TargetDummy) continue;
            // 计算与玩家的距离，可以改成与弹幕的距离
        ...
        if(shouldTeleport)
        {
            ...
            if(TeleportAlpha < 20)
            {
                ...
                Projectile.position = player.Center + 32 * new Vector2(Main.rand.Next(3, 8) * NormalUtils.Rand1or_1(), Main.rand.Next(3, 8) * NormalUtils.Rand1or_1());
                Projectile.velocity.X = NormalUtils.Rand1or_1() * Main.rand.NextFloat(1.49f, 1.94f);
